// ─────────────────────────────────────────────────────────────────────────────
// MG APPARELS LIMITED — Factory definition (demo / placeholder)
...
//   3. Add users in src/auth/users.ts with factoryId: 'mg_apparels'
// ─────────────────────────────────────────────────────────────────────────────

import type { FactoryConfig } from './FactoryTypes';

export const MG_APPARELS: FactoryConfig = {

  // ════════════════════════════════════════════════════════════════════════════
  // IDENTITY
  // ════════════════════════════════════════════════════════════════════════════
  id:        'mg_apparels',
  nameEn:    'MG APPARELS LIMITED',
  nameBn:    'এমজি অ্যাপারেলস লিমিটেড',
  addressEn: 'Tongi, Gazipur',
  addressBn: 'টঙ্গী, গাজীপুর',
  spreadsheetId: '199v6jC7e9xMGZb30eLPi-bgYq0m3bpcBThLYmNx9HTo',
  active:    true,
  db: { 
    adapter:       'sheets',
    spreadsheetId: '199v6jC7e9xMGZb30eLPi-bgYq0m3bpcBThLYmNx9HTo',
  ...
  // workerGuidelineTopics not set → all 32 topics shown by default.
  // ════════════════════════════════════════════════════════════════════════════
  workerProfile: {
